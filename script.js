const products = [
{ id:1, name:"Mouse Gamer RGB", description:"Sensor óptico de 3200 DPI e iluminação LED.", price:8.00, oldPrice:15.00, category:"mouse", stock:10, bestSeller:true, promo:true, img:"./imagem/09.png"},
{ id:2, name:"Kit Teclado e Mouse", description:"Combo ergonômico para produtividade.", price:49.00, category:"teclado", stock:2, bestSeller:true, promo:false, img:"./imagem/18660A.jpg"},
...
${p.bestSeller?'<span class="badge badge-best">Top Vendas</span>':''}

<img src="${p.img}" alt="${p.name}" onerror="this.src='./imagem/no-image.png'">
...
showToast(`Cupom aplicado ${discount*100}% OFF`);
...
if(discount>0)
msg+=`%0A🏷️ Desconto: ${document.getElementById("cartDiscount").innerText}`;
