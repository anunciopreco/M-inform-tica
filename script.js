...
function applyCoupon() {
    ...
    if (code === "TECH10") {
        discount = 0.10;
        showToast("Cupom TECH10 aplicado (10%)");
    } else if (code === "MARIA15") {
        discount = 0.15;
        showToast("Cupom MARIA15 aplicado (15%)");
    } else if (code === "PROMO20") { // exemplo de novo cupom
        discount = 0.20;
        showToast("Cupom PROMO20 aplicado (20%)");
    } else {
        showToast("Cupom inválido");
        return; // sai da função sem atualizar o carrinho
    }
